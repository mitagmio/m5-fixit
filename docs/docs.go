...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "name": "recordGameRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/slots.RecordGameRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Игра успешно записана",
                        "schema": {
                            "$ref": "#/definitions/slots.SuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Ошибка с некорректной ставкой или выигрышем",
                        "schema": {
                            "$ref": "#/definitions/slots.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Ошибка сервера при записи игры",
                        "schema": {
                            "$ref": "#/definitions/slots.ErrorResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "slots.RecordGameRequest": {
            "type": "object",
            "properties": {
                "bet": {
                    "description": "Ставка игрока",
                    "type": "number"
                },
                "result": {
                    "description": "Результат игры",
