...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.DailyBonusResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "controllers.DailyBonusResponse": {
            "type": "object",
            "properties": {
                "bonus_given": {
                    "description": "Был ли начислен бонус",
                    "type": "boolean"
                },
                "bot_games": {
                    "description": "Игры против бота",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entities.GameHistoryItem"
                    }
                },
                "pvp_games": {
                ...
                "total_games": {
                    "description": "Общее количество игр за сутки",
                    "type": "integer"
                }
            }
        },
        ...
        "general.GameHistoryResponse": {
            ...
            "properties": {
                "bet_amount": {
                    "description": "изменено с BetAmount",
                    "type": "number"
                },
                "counter": {
                    "description": "изменено с Counter",
                    "type": "integer"
                },
                "player1_earnings": {
                    "description": "изменено с Player1Earnings",
                    "type": "number"
                },
                "player1_name": {
                    "description": "изменено с Player1Name",
                    "type": "string"
                },
                "player1_score": {
                    "description": "изменено с Player1Score",
                    "type": "integer"
                },
                "player2_earnings": {
                    "description": "изменено с Player2Earnings",
                    "type": "number"
                },
                "player2_name": {
                    "description": "изменено с Player2Name",
                    "type": "string"
                },
                "player2_score": {
                    "description": "изменено с Player2Score",
                    "type": "integer"
                },
                "time_played": {
                    "description": "изменено с TimePlayed",
                    "type": "string"
                },
                "token_type": {
                    "description": "изменено с TokenType",
                    "type": "string"
                },
                "winner": {
                    "description": "изменено с Winner",
                    "type": "string"
                }
            }
        },
